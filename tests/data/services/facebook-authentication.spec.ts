...
describe('FacebookAuthenticationService', () => {
  ...
  it('should call CreateFacebookAccountRepo when facebookApi returns undefined', async () => {
    await sut.perform({ token })
  ...
  it('should call UpdateFacebookAccountRepo when facebookApi returns data', async () => {
